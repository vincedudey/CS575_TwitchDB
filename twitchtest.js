            ...
            success: function(data2){
              ...
              //for(var i=0; i<data2.length; i++)
                ...
                if(data2.streams[0] != null){
                  ...
                  num_followers:data2.streams[0].channel.followers, created_at:data2.streams[0].created_at, updated_at: data2.streams[0].channel.updated_at, url:data2.streams[0].channel.url};
                ...
                if(listChannels.length == 50 - subtract){
                  ...
                  for(var i=0; i<sortedList.length; i++){
                      $("#channel_name").append(i+1 +') <a target = "blank" href = ' + sortedList[i].url + '>' + sortedList[i].channel_name + "<br>");
                      // $("#channel_name").append('<a target = "blank" href = "https://www.twitch.tv/' + data2.streams[0].channel.name + '">' + data2.streams[0].channel.display_name + '</a><br>');
                      ...
                      $("#up_time").append(convertTimeToDuration(sortedList[i].created_at, sortedList[i].updated_at) + " hrs <br>");
                  }
                }
             }
